...
<div class="min-h-screen flex flex-col">
	...
	<main class="flex flex-col grow h-full">
		{@render children()}
	</main>

	<footer
		class="mt-auto w-full max-w-[90rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto"
	>
		<!-- Grid -->
		<div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
			<div>
				<a
					class="flex-none text-xl font-black text-slate-700 focus:outline-hidden dark:text-white"
					href="/"
